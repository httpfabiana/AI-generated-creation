...
export const AiToolsData = [
    {
        title: 'Redação de artigo por IA',
        description: 'Gere artigos de alta qualidade e envolventes sobre qualquer assunto com nossa tecnologia de redação por IA.',
        Icon: SquarePen,
        bg: { from: '#3588F2', to: '#0BB0D7' },
        path: '/ai/write-article'
    },
    {
        title: 'Gerador de Títulos de Blog',
        description: 'Encontre o titulo perfeito e chamativo para as postagens do seu blog com nosso gerador em IA.',
        Icon: Hash,
    ...
    },
    {
        ...
        description: 'Tenha seu currículo analisado por IA para aumentar suas chances de conquistar o emprego dos seus sonhos..',
        Icon: FileText,
...
export const dummyCreationData = [
    {
        ...
        "prompt": "Gere um título de blog para a palavra-chave 'blog' na categoria Tecnologia..",
    ...
    },
    {
        "id": 8,
        "user_id": "user_2yMX02PRbyMtQK6PebpjnxvRNIA",
        "prompt": "Gere um título de blog para a palavra-chave 'blog' na categoria Geral..",
    ...
    },
    {
        "id": 7,
        "user_id": "user_2yMX02PRbyMtQK6PebpjnxvRNIA",
        "prompt": "Escreva um artigo conciso (de 500 a 800 palavras) sobre IA e programação..",
...
export const dummyPublishedCreationData = [
    {
        "id": 1,
        "user_id": "user_2yMX02PRbyMtQK6PebpjnxvRNIA",
        "prompt": "Gere uma imagem de um menino em um barco pescando, no estilo anime.",
    ...
    },
    {
        "id": 2,
        "user_id": "user_2yMX02PRbyMtQK6PebpjnxvRNIA",
        "prompt": "Gere uma imagem de um menino andando de bicicleta em uma estrada, sendo a bicicleta do ano 2201, no estilo anime..",
    ...
    },
    {
        ...
        "prompt": "Gere uma imagem de um menino dirigindo um carro no céu, em estilo realista..",
