    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 py-24'>
            <div className='text-center'>
                <h2 className='text-slate-700 text-[42px] font-semibold'>Amado Pelos Criadores</h2>
                <p className='text-gray-500 max-w-lg mx-auto'>Não acredite apenas na nossa palavra. Veja o que nossos usuários estão dizendo.</p>
            </div>
